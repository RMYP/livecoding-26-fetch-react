...
function App() {
  ...
  async function handleSelectPlace(selectedPlace) {
    ...
    try {
      ...
      // next development - error hendler BE dan FE
      setErrorUpdatingUserPlaces({message: error.message || "Ada error waktu delete user places"})
    }
    ...
    <>
      <Modal open={errorUpdatingUserPlaces} onClose={handleError}>
        {errorUpdatingUserPlaces && (
          <Error title="An error oqured" message={errorUpdatingUserPlaces.message}></Error>
        )}
      </Modal>
